...
typedef struct treeInt{
	int value;
	struct treeInt *left, *right;
}nodeInt;

typedef nodeInt* treeInt;
...
/*PRIMITIVE*/
extern boolean isEmptyTree(tree t);
...
extern boolean memberTreeOrd(element e, tree t);
extern tree deleteTree(element e, tree t);
